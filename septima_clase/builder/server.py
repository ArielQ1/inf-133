...
#Base de Datos de simulada de Tacos
tacos = {}
...
class Taco:
    ...
    def __str__(self):
        return f"Base: {self.base}, Guiso: {self.guiso}, Toppins: {', '.join(self.toppings)}"
...
#Aplicando el principio de responsabilidad unica (S de SOLID)
class TacoService:
    def __init__(self):
